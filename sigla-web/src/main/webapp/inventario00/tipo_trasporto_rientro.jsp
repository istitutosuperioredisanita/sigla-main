...
<% CRUDTipoTrasportoRientroBP bp = (CRUDTipoTrasportoRientroBP)BusinessProcess.getBusinessProcess(request);
	...
	<table class="Panel">
		...
		<tr>
		  ...
		  <td>
			<% bp.getController().writeFormInput(out,null,"tiDocumento",bp.isEditing(),null,"onClick=\"submitForm('doOnTiDocumentoChange')\"");%>
		  </td>
		</tr>
		<tr>
		  <td>
		  ...
		  <td>
			<% bp.getController().writeFormInput(out,null,"flAbilitaNote",bp.isEditing(),null,null);%>
		  </td>
		</tr>
		<tr>
		  <td>
		  ...
		  <td>
			<% bp.getController().writeFormInput(out,null,"dtCancellazione",true,null,null);%>
		  </td>
		</tr>
	</table>
