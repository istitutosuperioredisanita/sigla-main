...
<div class="Group">
    ...
    <table>
      ...
      <tr>
       ...
       <td colspan="2"><% bp.getDettaglio().writeFormInput(out,null,"bene.find_categoria_bene",!bp.isInserting(),null,null); %></td>
      </tr>

      <tr>
       <td><% bp.getDettaglio().writeFormLabel(out,"bene.ubicazione"); %></td>
       <td colspan="2"><% bp.getDettaglio().writeFormInput(out,null,"bene.ubicazione",!bp.isInserting(),null,null); %></td>
      </tr>
    </table>
    ...
    <table>
      ...
      <tr>
       ...
       <td><% bp.getDettaglio().writeFormInput(out,null,"bene.condizioneBene",!bp.isInserting(),null,null); %></td>
      </tr>

      <tr>
       <td><% bp.getDettaglio().writeFormLabel(out,"note"); %></td>
       <td><% bp.getDettaglio().writeFormInput(out,null,"note",false,null,null); %></td>
      </tr>
    </table>
  </div>