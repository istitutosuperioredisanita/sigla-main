<%@ page pageEncoding="UTF-8"
    ...
    it.cnr.contab.inventario01.bulk.Stampa_doc_trasporto_rientroBulk"
%>
...
<title>Stampa Documento di Trasporto Rientro</title>
</head>
<body class="Form">

<%  BulkBP bp = (BulkBP)BusinessProcess.getBusinessProcess(request);
    Stampa_doc_trasporto_rientroBulk bulk = (Stampa_doc_trasporto_rientroBulk)bp.getModel();
