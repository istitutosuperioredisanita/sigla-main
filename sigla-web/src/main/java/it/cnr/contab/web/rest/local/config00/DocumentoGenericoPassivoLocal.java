...
public interface DocumentoGenericoPassivoLocal {
    ...
    @ApiOperation(value = "Crea documento generico passivo ",
            ...
            response = DocumentoGenericoPassRigaDto.class,
            authorizations = {
    ...
    @GET
    @Path("/{cd_cds}/{cd_unita_organizzativa}({esercizio}/{cd_tipo_documento_amm}/{pg_documento_generico}")
    ...
    Response get(@PathParam("cd_cds") String cd_cds,@PathParam("cd_unita_organizzativa") String cd_unita_organizzativa,@PathParam("esercizio")Integer esercizio,
                @PathParam("cd_tipo_documento_amm") String cd_tipo_documento_amm,@PathParam("pg_documento_generico") Long pg_documento_generico ) throws Exception;
    @DELETE
    @Path("/{cd_cds}/{cd_unita_organizzativa}({esercizio}/{cd_tipo_documento_amm}/{pg_documento_generico}")
