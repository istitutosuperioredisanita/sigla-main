...
<div class="col-md-8 mx-auto">
    <div class="card card-shadow">
        ...
        <div class="card-block p-3">
            ...
            <%
                String cdTipoBilancioCorrente = ((GruppoEPBulk)bp.getModel()).getCdTipoBilancio();

                boolean mostraTassAccrual = TipoBilancioBulk.ACCRUAL.equals(cdTipoBilancioCorrente) || TipoBilancioBulk.ACCRUAL_AGG.equals(cdTipoBilancioCorrente);
            %>
            <% if (mostraTassAccrual) { %>
            <div class="form-row">
                <div class="col-md-12"><% bp.getController().writeFormField(out, "nomeTassAccrual", Boolean.FALSE);%></div>
            </div>
            <% } %>
        </div>
