...
<div class="Group card p-3" style="width:100%">
	...
	<%if(fatturaPassiva.getLettera_pagamento_estero()!=null && fatturaPassiva.getLettera_pagamento_estero().getLettera_vers().equals(Lettera_pagam_esteroBulk.PRIMA_VERSIONE) ) {%>
		<table width="100%">
			<tr>
