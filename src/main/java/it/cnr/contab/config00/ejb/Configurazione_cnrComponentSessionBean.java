...
public class Configurazione_cnrComponentSessionBean extends it.cnr.jada.ejb.CRUDDetailComponentSessionBean implements Configurazione_cnrComponentSession {
    ...
    public Boolean isAttivaFinanziaria(UserContext userContext, int esercizio) throws ComponentException, RemoteException {
        pre_component_invocation(userContext, componentObj);
        try {
            Boolean result = ((Configurazione_cnrComponent)componentObj).isAttivaFinanziaria(userContext, esercizio);
            component_invocation_succes(userContext, componentObj);
            return result;
        } catch (it.cnr.jada.comp.NoRollbackException e) {
            component_invocation_succes(userContext, componentObj);
    ...
    public Boolean isAttivoGestFirmatariCont(UserContext userContext) throws ComponentException, RemoteException {
        pre_component_invocation(userContext, componentObj);
        try {
            Boolean result = ((Configurazione_cnrComponent)componentObj).isAttivoGestFirmatariCont(userContext);
            component_invocation_succes(userContext, componentObj);
            return result;
        } catch (it.cnr.jada.comp.NoRollbackException e) {
            component_invocation_succes(userContext, componentObj);
    ...
    public Boolean isNoAperturaGaeSuProgettoInizialeEnable(UserContext userContext) throws ComponentException, RemoteException {
        pre_component_invocation(userContext, componentObj);
        try {
            Boolean result = ((Configurazione_cnrComponent)componentObj).isNoAperturaGaeSuProgettoInizialeEnable(userContext);
            component_invocation_succes(userContext, componentObj);
            return result;
        } catch (it.cnr.jada.comp.NoRollbackException e) {
            component_invocation_succes(userContext, componentObj);
    ...
    public Boolean isAttivaFirmaOrdine(UserContext param0,int esercizio) throws ComponentException, RemoteException {
        pre_component_invocation(param0, componentObj);
        try {
            Boolean result = ((Configurazione_cnrComponent)componentObj).isAttivaFirmaOrdine(param0,esercizio);
            component_invocation_succes(param0, componentObj);
            return result;
        } catch (it.cnr.jada.comp.NoRollbackException e) {
            component_invocation_succes(param0, componentObj);
