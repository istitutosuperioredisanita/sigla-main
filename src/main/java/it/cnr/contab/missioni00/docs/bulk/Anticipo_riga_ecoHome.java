...
public class Anticipo_riga_ecoHome extends BulkHome {
    public Anticipo_riga_ecoHome(Class classe, java.sql.Connection conn) {
        super(classe, conn);
    }

    public Anticipo_riga_ecoHome(Class classe, java.sql.Connection conn, PersistentCache persistentCache) {
