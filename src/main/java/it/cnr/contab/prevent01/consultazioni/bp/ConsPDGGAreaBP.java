...
import it.cnr.contab.prevent01.consultazioni.ejb.ConsPDGGAreaComponentSession;
...
public class ConsPDGGAreaBP extends ConsultazioniBP {
	...
	public ConsPDGGAreaComponentSession createPdggAreaComponentSession() throws jakarta.ejb.EJBException,java.rmi.RemoteException {
	   ...
	   protected void init(it.cnr.jada.action.Config config,it.cnr.jada.action.ActionContext context) throws it.cnr.jada.action.BusinessProcessException {
		   ...
		   if (getPathConsultazione()==null) {
				if (this instanceof ConsPDGGAreaEtrBP){
	   ...
	   public java.util.Vector addButtonsToToolbar(java.util.Vector listButton){
		   ...
		   if (getLivelloConsultazione().equals(this.LIVELLO_LIV3)&& this instanceof ConsPDGGAreaEtrBP) {
	   ...
	   public void setTitle() {
		   String title=null;
		   if (this instanceof ConsPDGGAreaEtrBP)
			   title = "Riepilogo PDGG per Area/Istituto-Entrate";
		   else
			   title = "Riepilogo PDGG per Area/Istituto-Spese";
	   ...
	   public String getDs_livello1(UserContext userContext) throws BusinessProcessException {
		   try {
			   if (getDs_livello1()==null) {
				   if (this instanceof ConsPDGGAreaSpeBP)
	...
	/**
	   ...
	   public CompoundFindClause getSelezione(ActionContext context) throws it.cnr.jada.action.BusinessProcessException {
		   try	{
			   ...
			   {
				   V_cons_pdgg_areaBulk wpb = (V_cons_pdgg_areaBulk)i.next();
