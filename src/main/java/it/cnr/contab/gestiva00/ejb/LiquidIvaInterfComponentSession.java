...
public interface LiquidIvaInterfComponentSession extends it.cnr.jada.ejb.CRUDComponentSession {
	...
	it.cnr.contab.gestiva00.core.bulk.Liquidazione_massa_ivaVBulk inizializzaMese(it.cnr.jada.UserContext param0,it.cnr.contab.gestiva00.core.bulk.Liquidazione_massa_ivaVBulk param1) throws it.cnr.jada.comp.ComponentException,it.cnr.jada.persistency.PersistencyException,java.rmi.RemoteException;
}