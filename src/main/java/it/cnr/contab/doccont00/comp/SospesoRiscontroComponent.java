...
//			ps.setString(1, "Y");
    ...
    public ResultScrittureContabili createScritturaPartitaDoppia(UserContext userContext, boolean tesoreriaUnica, EnteBulk cdsEnte, MovimentoContoEvidenzaBulk riga) throws ComponentException, jakarta.ejb.EJBException, it.cnr.jada.persistency.PersistencyException, RemoteException{
