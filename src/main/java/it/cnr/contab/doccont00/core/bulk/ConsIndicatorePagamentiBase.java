...
public class ConsIndicatorePagamentiBase extends OggettoBulk implements Persistent {
	 ...
	 **/
	public ConsIndicatorePagamentiBase() {
		super();
	}
	/**
	 * Created by BulkGenerator 2.0 [07/12/2009]
	...
	public java.lang.Integer getHashTrimestre() {
		return Optional.ofNullable(trimestre).orElse(0);
	}
