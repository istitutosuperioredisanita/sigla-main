...
public class StampaIndiceTempestivitaPagamentiAction extends ParametricPrintAction {
    ...
    public Forward doExcel(ActionContext actioncontext) {
        try {
            ...
            final ConsIndicatorePagamentiBulk vConsIndicatorePagamentiBulk = new ConsIndicatorePagamentiBulk();
            ...
            BulkInfo bulkInfo = BulkInfo.getBulkInfo(ConsIndicatorePagamentiBulk.class);
