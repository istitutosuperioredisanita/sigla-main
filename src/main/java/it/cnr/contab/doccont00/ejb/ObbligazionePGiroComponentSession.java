...
@Remote
public interface ObbligazionePGiroComponentSession extends it.cnr.jada.ejb.CRUDComponentSession, it.cnr.contab.doccont00.comp.DocumentoContabileComponentSession {
...
it.cnr.contab.doccont00.core.bulk.ImpegnoPGiroBulk annullaObbligazione(it.cnr.jada.UserContext param0,it.cnr.contab.doccont00.core.bulk.ImpegnoPGiroBulk param1) throws it.cnr.jada.comp.ComponentException,java.rmi.RemoteException;
...
it.cnr.contab.doccont00.core.bulk.ImpegnoPGiroBulk creaObbligazione(it.cnr.jada.UserContext param0,it.cnr.contab.doccont00.core.bulk.AccertamentoPGiroBulk param1) throws it.cnr.jada.comp.ComponentException,java.rmi.RemoteException;
void eliminaObbligazione(it.cnr.jada.UserContext param0,it.cnr.contab.doccont00.core.bulk.ImpegnoPGiroBulk param1) throws it.cnr.jada.comp.ComponentException,java.rmi.RemoteException;
...
it.cnr.contab.doccont00.core.bulk.ImpegnoPGiroBulk modificaObbligazione(it.cnr.jada.UserContext param0,it.cnr.contab.doccont00.core.bulk.AccertamentoPGiroBulk param1) throws it.cnr.jada.comp.ComponentException,java.rmi.RemoteException;
