...
public interface AccertamentoResiduoComponentSession extends AccertamentoComponentSession {
	...
	void aggiornaImportoAccertamento(it.cnr.jada.UserContext param0, it.cnr.contab.doccont00.core.bulk.AccertamentoBulk param1, java.math.BigDecimal param2, WorkpackageBulk param3, String param4) throws it.cnr.jada.comp.ComponentException,java.rmi.RemoteException;
}
