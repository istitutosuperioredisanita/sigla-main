...
public class ConsRiepilogoSiopeReversaliBP extends BulkBP {
	...
	public static final String LIV_BASEDETT= "DETT";
		...
		protected void init(Config config, ActionContext context) throws BusinessProcessException {
				...
				V_cons_siope_reversaliBulk bulk = new V_cons_siope_reversaliBulk();
		...
		public void setTitle() {
			   ...
			   String title=null;
			   		   title = "Consultazione Riepilogo Codici Siope su Reversali";
	...
	/*	public void valorizzaDate(ActionContext context, V_cons_siope_reversaliBulk bulk) throws ValidationException{
			if ((bulk.getDt_emissione_da()== null||bulk.getDt_emissione_a()==null)&&
					(bulk.getDt_incasso_da()== null||bulk.getDt_incasso_a()== null)&&
					(bulk.getDt_trasmissione_da()== null||bulk.getDt_trasmissione_a()== null))
					throw new ValidationException("Valorizzare o le Date di Emissione o le Date di Incasso o le Date di Trasmissione");	
		}
*/
