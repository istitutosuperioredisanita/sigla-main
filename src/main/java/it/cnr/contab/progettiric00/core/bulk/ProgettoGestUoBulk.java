...
public class ProgettoGestUoBulk extends ProgettoGestUoBase {
...
public ProgettoGestUoBulk() {
	super();
}
public ProgettoGestUoBulk(java.lang.Integer esercizio,java.lang.Integer pg_progetto,java.lang.String tipo_fase,java.lang.String cd_unita_organizzativa) {
	super(esercizio,pg_progetto,tipo_fase,cd_unita_organizzativa);
}
   /**
	...
	*/
	public void addToProgetti_figli(ProgettoGestUoBulk figlio) {
...
public void setUnita_organizzativa(it.cnr.contab.config00.sto.bulk.Unita_organizzativaBulk newUnita_organizzativa) {
	...
	public boolean isProgetto(){
		return getLivello().equals(ProgettoGestUoBulk.LIVELLO_PROGETTO_PRIMO);
	}
	public boolean isCommessa(){
		return getLivello().equals(ProgettoGestUoBulk.LIVELLO_PROGETTO_SECONDO);
	}
	public boolean isModulo(){
		return getLivello().equals(ProgettoGestUoBulk.LIVELLO_PROGETTO_TERZO);
	}
}