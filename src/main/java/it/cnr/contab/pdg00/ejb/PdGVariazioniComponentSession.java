...
public interface PdGVariazioniComponentSession extends it.cnr.jada.ejb.CRUDComponentSession, it.cnr.jada.ejb.PrintComponentSession {
    ...
    byte[] lanciaStampa(it.cnr.jada.UserContext userContext,Integer esercizio,Integer pg_variazione,String tipo_variazione) throws PersistencyException, ComponentException,java.rmi.RemoteException, jakarta.ejb.EJBException;
    ...
    OggettoBulk creaConBulk(UserContext userContext, OggettoBulk bulk, boolean sendMessage) throws ComponentException;
}
