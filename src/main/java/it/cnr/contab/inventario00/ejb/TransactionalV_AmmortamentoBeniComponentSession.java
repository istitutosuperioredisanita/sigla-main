...
public class TransactionalV_AmmortamentoBeniComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements V_AmmortamentoBeniComponentSession {
    ...
    public List<V_ammortamento_beniBulk> findAllBeniDaAmmortizare(UserContext param0, Integer param1) throws ComponentException, RemoteException {
        ...
        try {
            return (List<V_ammortamento_beniBulk>)invoke("findAllBeniDaAmmortizare",new Object[] {
                    param0,
                    param1 });
