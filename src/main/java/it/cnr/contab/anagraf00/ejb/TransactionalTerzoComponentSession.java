...
public it.cnr.jada.util.RemoteIterator cercaBanchePerTerzoCessionario(it.cnr.jada.UserContext param0,it.cnr.contab.anagraf00.core.bulk.Modalita_pagamentoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException,it.cnr.jada.persistency.PersistencyException {
	try {
		return (it.cnr.jada.util.RemoteIterator)invoke("cercaBanchePerTerzoCessionario",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public it.cnr.jada.util.RemoteIterator cercaModalita_pagamento_disponibiliByClause(it.cnr.jada.UserContext param0,it.cnr.contab.anagraf00.core.bulk.TerzoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException,it.cnr.jada.persistency.PersistencyException {
	try {
		return (it.cnr.jada.util.RemoteIterator)invoke("cercaModalita_pagamento_disponibiliByClause",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public it.cnr.contab.anagraf00.core.bulk.TerzoBulk cercaTerzoPerUnitaOrganizzativa(it.cnr.jada.UserContext param0,it.cnr.contab.config00.sto.bulk.Unita_organizzativaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.anagraf00.core.bulk.TerzoBulk)invoke("cercaTerzoPerUnitaOrganizzativa",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public it.cnr.contab.anagraf00.core.bulk.TerzoBulk inizializzaTerzoPerUnitaOrganizzativa(it.cnr.jada.UserContext param0,it.cnr.contab.config00.sto.bulk.Unita_organizzativaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.anagraf00.core.bulk.TerzoBulk)invoke("inizializzaTerzoPerUnitaOrganizzativa",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public it.cnr.contab.anagraf00.core.bulk.TerzoBulk setComune_sede(it.cnr.jada.UserContext param0,it.cnr.contab.anagraf00.core.bulk.TerzoBulk param1,it.cnr.contab.anagraf00.tabter.bulk.ComuneBulk param2) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.anagraf00.core.bulk.TerzoBulk)invoke("setComune_sede",new Object[] {
			param0,
			param1,
			param2 });
	} catch(java.rmi.RemoteException e) {
...
public java.util.List findListaTerziSIP(it.cnr.jada.UserContext param0,String param1,String param2,String param3,String param4) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (java.util.List)invoke("findListaTerziSIP",new Object[] {
			param0,
			param1,
			param2,
			param3,
...
public java.util.List findNazioniIban(it.cnr.jada.UserContext param0,it.cnr.contab.anagraf00.core.bulk.BancaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (java.util.List)invoke("findNazioniIban",new Object[] {
			param0,
			param1});
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public java.util.List findListaTerziSIP_rendicontazione(it.cnr.jada.UserContext param0,String param1,String param2,String param3,String param4,Timestamp param5, Timestamp param6,String param7) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (java.util.List)invoke("findListaTerziSIP_rendicontazione",new Object[] {
			param0,
			param1,
			param2,
			param3,
...
public it.cnr.contab.anagraf00.core.bulk.TerzoBulk completaTerzo(it.cnr.jada.UserContext param0,it.cnr.contab.anagraf00.core.bulk.TerzoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.anagraf00.core.bulk.TerzoBulk)invoke("completaTerzo",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
