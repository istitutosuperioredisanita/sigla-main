...
public class Fattura_passiva_riga_ecoKey extends OggettoBulk implements KeyedPersistent {
    ...
    public Fattura_passiva_riga_ecoKey() {
        super();
    }

    public Fattura_passiva_riga_ecoKey(String cd_cds, String cd_unita_organizzativa, Integer esercizio, Long pg_fattura_passiva, Long progressivo_riga, Long progressivo_riga_eco) {
        this.cd_cds = cd_cds;
    ...
    public boolean equalsByPrimaryKey(Object o) {
        ...
        if (!(o instanceof Fattura_passiva_riga_ecoKey)) return false;
        Fattura_passiva_riga_ecoKey k = (Fattura_passiva_riga_ecoKey) o;
