...
import it.cnr.contab.ordmag.ordini.bulk.OrdineAcqDefinitiviBulk;
import it.cnr.contab.ordmag.ordini.bulk.OrdineAcqProvvisoriBulk;
import it.cnr.contab.ordmag.ordini.bulk.OrdineAcqTuttiBulk;
...
public class Filtro_ricerca_doc_ammVBulk extends it.cnr.jada.bulk.OggettoBulk {
	...
	public static final String DOC_ORDINI_GROUP = "Ordini";
    ...
    static {
		...
		GROUPS.put(DOC_ORDINI_GROUP, DOC_ORDINI_GROUP);
    }
    ...
    private OrderedHashtable buildOptionsHash() {
		...
		options = new OrderedHashtable();
		options.put(OrdineAcqTuttiBulk.class.getName(), "Tutti");
		options.put(OrdineAcqProvvisoriBulk.class.getName(), "Provvisori");
		options.put(OrdineAcqDefinitiviBulk.class.getName(), "Definitivi");
		optionsHash.put(DOC_ORDINI_GROUP, options);
