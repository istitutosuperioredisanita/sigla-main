...
public class Fattura_passiva_riga_ecoBase extends Fattura_passiva_riga_ecoKey implements Keyed {
    // ESERCIZIO_VOCE_ANA DECIMAL(4,0) NOT NULL
    private java.lang.Integer esercizio_voce_ana;
    ...
    public Fattura_passiva_riga_ecoBase() {
        super();
    }

    public Fattura_passiva_riga_ecoBase(String cd_cds, String cd_unita_organizzativa, Integer esercizio, Long pg_fattura_passiva, Long progressivo_riga, Long progressivo_riga_eco) {
