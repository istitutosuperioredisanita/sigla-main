...
public class CRUDNotaDiDebitoAttivaBP 
	...
	private final CollapsableDetailCRUDController childrenAnaColl = new DetailEcoCogeCRUDController(Nota_di_debito_attiva_riga_ecoBulk.class, this.getDettaglio());
