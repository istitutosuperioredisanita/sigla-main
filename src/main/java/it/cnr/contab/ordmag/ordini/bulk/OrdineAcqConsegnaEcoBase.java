...
public class OrdineAcqConsegnaEcoBase extends OrdineAcqConsegnaEcoKey implements Keyed {
    ...
    public OrdineAcqConsegnaEcoBase() {
        super();
    }

    public OrdineAcqConsegnaEcoBase(String cdCds, String cdUnitaOperativa, Integer esercizio, String cdNumeratore, Integer numero, Integer riga, java.lang.Integer consegna, Long progressivo_riga_eco) {
        super(cdCds, cdUnitaOperativa, esercizio, cdNumeratore, numero, riga, consegna,progressivo_riga_eco);
    }
