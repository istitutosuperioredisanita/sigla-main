...
public class OrdineAcqConsegnaEcoBulk extends OrdineAcqConsegnaEcoBase implements IDocumentoDetailAnaCogeBulk {
    ...
    public OrdineAcqConsegnaEcoBulk() {
        super();
    }

    public OrdineAcqConsegnaEcoBulk(String cdCds, String cdUnitaOperativa, Integer esercizio, String cdNumeratore, Integer numero, Integer riga, java.lang.Integer consegna, Long progressivo_riga_eco) {
