...
--
-- Date: 27/06/2025 (Aggiornato per spese tracciate/no n tracciate) 
-- Version: 1.14
--
  	 ...
  	 -- ciclo sui capitoli associati alla missione
  	  ...
  	  -- inizio loop 3
  		 ...
  		 insert into VPG_MISSIONE (ID,
  									...
  									DT_FINE_MISSIONE,
  									IBAN,
                                      IM_SPESE_NO_TRACC, --- MODIFICHE PER SPESE TRACCIATE ---
                                      IM_SPESE_TRACC    --- MODIFICHE PER SPESE TRACCIATE ---
                                      )
  		 select aId,
  				 ...
  				 nvl(ban.CIN,' '),
  	 			 ...
  	 			 ban.codice_iban,
                  aMiss.IM_SPESE_NO_TRACC, --- MODIFICHE PER SPESE TRACCIATE ---
                  aMiss.IM_SPESE_TRACC    --- MODIFICHE PER SPESE TRACCIATE ---
  	...
  	-- inizio loop 6
  	  ...
  	  i := i+1;
  		...
  		insert into VPG_MISSIONE (ID,
  								 ...
  								 DS_SPESA,
  								 FL_SPESA_ANTICIPATA,
                                  FL_SPESA_TRACCIATA, --- MODIFICHE PER SPESE TRACCIATE ---
  								 CD_DIVISA_SPESA,
  								 IM_SPESA_DIVISA,
  								 CAMBIO_SPESA,
  	 	...
  	 	values (aId,
  			  'BA:spese dettagli',
                  ...
                  aMdet.FL_SPESA_TRACCIATA, --- MODIFICHE PER SPESE TRACCIATE ---
