...
SELECT
       ...
       'N'
FROM   ASS_COMP_DOC_CONT_NMP ASS
LEFT OUTER JOIN MANDATO M ON M.CD_CDS = ASS.CD_CDS_DOC AND M.ESERCIZIO = ASS.ESERCIZIO_DOC AND M.PG_MANDATO = ASS.PG_DOC
LEFT OUTER JOIN REVERSALE R ON R.CD_CDS = ASS.CD_CDS_DOC AND R.ESERCIZIO = ASS.ESERCIZIO_DOC AND R.PG_REVERSALE = ASS.PG_DOC, COMPENSO C
