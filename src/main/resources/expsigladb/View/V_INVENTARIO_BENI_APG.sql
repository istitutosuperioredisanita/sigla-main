...
CREATE OR REPLACE FORCE VIEW "V_INVENTARIO_BENI_APG" (
    "PG_INVENTARIO",
    "NR_INVENTARIO",
    "PROGRESSIVO",
    "DS_BENE",
    ...
    "VALORE_AMMORTIZZATO",
    "VARIAZIONE_PIU",
    "VARIAZIONE_PIU_INIZIALE",
    "VARIAZIONE_MENO",
    "VARIAZIONE_MENO_INIZIALE",
...
-- Date: 14/10/2022
-- Version: 1.7
-- Aggiunta campi dismissione bene : FL_DISMESSO, DT_DISMESSO, CAUSALE_DISMESSO
--
-- Date: 10/12/2025
-- Version: 1.8
-- Aggiunta campo FL_BENE_IN_IST per gestione stato fisico del bene (dentro/fuori istituto)
--
-- Body:
--
    inv.PG_INVENTARIO,
