...
CASE WHEN SPD.ORIGINE_SCRITTURA = 'DOCCONT' THEN NVL(M.DT_EMISSIONE, R.DT_EMISSIONE) ELSE
    CASE WHEN MC.CD_TIPO_DOCUMENTO = 'FATTURA_P' THEN FP.DT_REGISTRAZIONE
         ...
         WHEN MC.CD_TIPO_DOCUMENTO = 'COMPENSO' THEN FA.DT_REGISTRAZIONE
    END
END DT_EM_PAG,
CASE WHEN MC.CD_TIPO_DOCUMENTO = 'FATTURA_P' THEN FP.DT_FATTURA_FORNITORE ELSE NULL END DT_FATTURA_FORNITORE,
...
CASE WHEN MC.CD_TIPO_DOCUMENTO = 'FATTURA_P' THEN FP.IDENTIFICATIVO_SDI
     WHEN MC.CD_TIPO_DOCUMENTO = 'FATTURA_A' THEN TO_NUMBER(REGEXP_REPLACE(FA.CODICE_INVIO_SDI, '[^0-9]', '')) ELSE NULL END IDENTIFICATIVO_SDI,
