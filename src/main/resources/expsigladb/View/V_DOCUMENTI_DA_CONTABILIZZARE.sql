...
SELECT 'ORDINE_CNS' TIPODOC,
       CASE WHEN EVASIONE_ORDINE_RIGA.ESERCIZIO IS NULL
            ...
            ELSE CASE WHEN FATTURA_PASSIVA.ESERCIZIO IS NULL
                          THEN EVASIONE_ORDINE_RIGA.ESERCIZIO
                      ELSE CASE WHEN EVASIONE_ORDINE.ESERCIZIO > FATTURA_PASSIVA.ESERCIZIO
                                    THEN FATTURA_PASSIVA.ESERCIZIO
                                ELSE EVASIONE_ORDINE.ESERCIZIO
                           END
                 END
       END ESERCIZIO_CONT,
