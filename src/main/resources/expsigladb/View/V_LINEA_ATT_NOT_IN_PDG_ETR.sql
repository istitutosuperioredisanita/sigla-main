...
--------------------------------------------------------
  ...
  --
            uni.esercizio,
            uni.esercizio_inizio,
            uni.cd_linea_attivita,
            uni.pg_progetto,
            progetto.cd_progetto,
            progetto.p_cd_progetto CD_PROGETTO_PADRE,
            uni.ds_linea_attivita,
            uni.cd_centro_responsabilita,
            uni.cd_insieme_la,
            'E' ti_gestione,
            uni.denominazione,
            uni.cd_gruppo_linea_attivita,
            uni.cd_funzione,
            uni.cd_natura,
            uni.cd_tipo_linea_attivita,
            uni.cd_cdr_collegato,
            uni.cd_la_collegato,
            uni.esercizio_fine,
              uni.dacr,
            uni.utcr, uni.duva, uni.utuv, uni.pg_ver_rec, uni.ti_appartenenza,
            uni.ti_gestione_voce , uni.cd_elemento_voce, uni.cd_responsabile_terzo,
            uni.fl_limite_ass_obblig, uni.cd_cofog, uni.cd_programma, uni.cd_missione
            from ( SELECT
            b.esercizio, a.esercizio_inizio, a.cd_linea_attivita, a.pg_progetto,'P' tipo_fase   ,
            ...
            b.ti_gestione ti_gestione_voce, b.cd_elemento_voce, a.cd_responsabile_terzo,
     ...
     SELECT pdg_modulo_entrate_gest.esercizio, linea_attivita.esercizio_inizio,
            linea_attivita.cd_linea_attivita, linea_attivita.pg_progetto, 'G' tipo_fase  ,
            ...
            pdg_modulo_entrate_gest.ti_gestione ti_gestione_voce,
     ...
     UNION
     SELECT a.esercizio, esercizio_inizio, cd_linea_attivita, pg_progetto,null tipo_fase,
            ds_linea_attivita,
            ...
            e.ti_appartenenza, e.ti_gestione ti_gestione_voce, e.cd_elemento_voce,
        ...
        AND NOT EXISTS (
               ...
               SELECT 1
                ...
                WHERE a.cd_linea_attivita = b.cd_linea_attivita
                  ...
                  AND e.ti_gestione = b.ti_gestione)) uni ,
                  v_progetto_padre progetto
                  where progetto.pg_progetto=uni.pg_progetto
                  and progetto.esercizio=uni.esercizio
                  and ( uni.tipo_fase is null or progetto.tipo_fase=uni.tipo_fase);