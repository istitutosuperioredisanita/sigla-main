  ...
  */
  ...
  For aOrdine in (Select a.cd_cds, a.cd_unita_operativa, a.esercizio, a.cd_numeratore, a.numero
                  ...
                  Where a.cd_cds_obbl = aObb.cd_cds And
                        ...
                        a.pg_obbligazione=aObb.pg_obbligazione And
                        b.stato='INS') Loop
      IBMERR001.RAISE_ERR_GENERICO('L''obbligazione '||CNRCTB035.GETDESC(aObb)||' risulta associata all''ordine ('||
      aOrdine.cd_cds||'/'||aOrdine.cd_unita_operativa||'/'||aOrdine.esercizio||'/'||aOrdine.cd_numeratore||'/'||aOrdine.numero ||')  non definitivo');
  End Loop;
