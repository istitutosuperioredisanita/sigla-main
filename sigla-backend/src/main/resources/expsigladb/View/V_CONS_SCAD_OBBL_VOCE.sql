...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE Fix estrazion VIEW "V_CONS_SCAD_OBBL_VOCE" ("CDS", "UO", "ESERCIZIO", "ESERCIZIO_ORIGINALE", "PG_OBBL", "PG_OBBL_SCAD", "VOCE_BILANCIO", "DATA_SCAD", "DS_OBBL", "DS_SCAD", "IM_SCAD",
    "IM_ASS_DOC_AMM", "IMP_ASS_DOC_CONT", "CREDITORE", "DS_ELEMENTO_VOCE", "IM_VOCE", "PG_PROGETTO", "CD_PROGETTO", "DS_PROGETTO", "DT_INIZIO", "DT_FINE", "DT_PROROGA", "CD_TIPO_PROGETTO",
    "DS_TIPO_PROGETTO","IMP_EVASO","IMP_ORDINE","IMP_ASS_FATTURA","IMP_ASS_DOC_AMM") AS
    SELECT
      --
      -- Date: 12/08/2024
      -- Version: 1.0
