...
l.quantita_apertura,l.DT_MOVIMENTO_CHIUSURA,l.anno_riferimento_movimento,l.valore_unitario,prezzo_unitario_chiu
from (
...
0 quantita_apertura,null DT_MOVIMENTO_CHIUSURA,null anno_riferimento_movimento,l.valore_unitario,0 prezzo_unitario_chiu
from lotto_mag l
union all
...
mc.dt_riferimento dt_carico,  0 quantita_Scarico, null dt_scarico,0 quantita_apertura,null DT_MOVIMENTO_CHIUSURA,to_char ( mc.dt_riferimento,'yyyy') anno_riferimento_movimento,l.valore_unitario,0 as prezzo_unitario_chiu
...
null dt_carico,  (mc.coeff_conv*quantita) quantita_Scarico, mc.dt_riferimento,0 quantita_apertura,null DT_MOVIMENTO_CHIUSURA,to_char ( mc.dt_riferimento,'yyyy') anno_riferimento_movimento,l.valore_unitario,0 as prezzo_unitario_chiu
from lotto_mag l inner join
    movimenti_mag mc  on
    mc.CD_CDS_LOTTO=l.CD_CDS
    and mc.CD_MAGAZZINO_LOTTO=l.CD_MAGAZZINO
...
null dt_carico,  0 quantita_Scarico, null  dt_scarico,mc.quantita quantita_apertura,mc.dt_riferimento DT_MOVIMENTO_CHIUSURA ,to_char ( mc.dt_riferimento,'yyyy') anno_riferimento_movimento,l.valore_unitario,NVL(mc.prezzo_unitario,0) as prezzo_unitario_chiu
from lotto_mag l 
