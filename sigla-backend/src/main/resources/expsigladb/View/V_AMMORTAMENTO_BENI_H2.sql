...
LEFT OUTER JOIN ASS_TIPO_AMM_CAT_GRUP_INV ass ON ass.CD_CATEGORIA_GRUPPO = INV.CD_CATEGORIA_GRUPPO 
		AND ass.TI_AMMORTAMENTO = inv.TI_AMMORTAMENTO AND ass.dt_cancellazione is null
