CREATE OR REPLACE FORCE VIEW V_DOC_PASSIVO_OBBLIGAZIONE (
   ...
   SELECT    a.cd_cds, a.cd_unita_organizzativa, a.esercizio,
        ...
        LEFT JOIN obbligazione_scadenzario b ON b.cd_cds = a.cd_cds_obbligazione AND b.esercizio = a.esercizio_obbligazione
 			        AND b.esercizio_originale = a.esercizio_ori_obbligazione AND b.pg_obbligazione = a.pg_obbligazione
 			        AND b.pg_obbligazione_scadenzario = a.pg_obbligazione_scadenzario
        LEFT JOIN obbligazione c ON c.cd_cds = b.cd_cds AND c.esercizio = b.esercizio AND c.esercizio_originale = b.esercizio_originale
 			        AND c.pg_obbligazione = b.pg_obbligazione
        LEFT OUTER JOIN rif_modalita_pagamento d ON d.cd_modalita_pag = a.cd_modalita_pag
    GROUP BY a.cd_cds,
