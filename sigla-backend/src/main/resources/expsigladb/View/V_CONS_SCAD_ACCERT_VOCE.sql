...
--------------------------------------------------------
  ...
  -- Body
  --
     v."CDS",v."UO",v."ESERCIZIO",v."ESERCIZIO_ORIGINALE",v."PG_ACC",v."PG_ACC_SCAD",v."VOCE_BILANCIO",v."DATA_SCAD",v."ACC_DESC",v."DS_SCAD",v."IM_SCAD",v."IM_ASS_DOC_AMM",v."IMP_ASS_DOC_CONT",v."DEBITORE",v."CD_CDS_ACCERTAMENTO",v."DS_ELEMENTO_VOCE",p.pg_progetto,p.cd_progetto,p.ds_progetto,po.dt_inizio,po.dt_fine,po.dt_proroga,tp.cd_tipo_progetto,tp.ds_tipo_progetto from V_CONS_SCAD_ACCERT v
     ...
     inner join   v_linea_attivita_valida l
     on av.esercizio=l.esercizio
     and av.cd_linea_attivita=l.cd_linea_attivita
     and  av.cd_centro_responsabilita=l.cd_centro_responsabilita
     inner join progetto p
     on p.esercizio=l.esercizio
