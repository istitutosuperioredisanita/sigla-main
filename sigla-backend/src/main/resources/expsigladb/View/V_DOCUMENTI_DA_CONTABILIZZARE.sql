...
SELECT 'ORDINE_CNS' TIPODOC,
       ORDINE_ACQ_CONSEGNA.ESERCIZIO ESERCIZIO_CONT,
       ...
       ORDINE_ACQ.DATA_ORDINE DT_REGISTRAZIONE
...
WHERE (ORDINE_ACQ_CONSEGNA.STATO_COGE = 'N' OR ORDINE_ACQ_CONSEGNA.STATO_COGE = 'R')
AND NOT EXISTS(SELECT '1' FROM EVASIONE_ORDINE_RIGA
               WHERE EVASIONE_ORDINE_RIGA.CD_CDS_ORDINE = ORDINE_ACQ_CONSEGNA.CD_CDS
               ...
               AND EVASIONE_ORDINE_RIGA.STATO = 'INS')
UNION ALL
SELECT 'ORDINE_CNS' TIPODOC,
       EVASIONE_ORDINE_RIGA.ESERCIZIO ESERCIZIO_CONT,
       ORDINE_ACQ_CONSEGNA.ESERCIZIO,
       ORDINE_ACQ_CONSEGNA.CD_CDS,
       NULL CD_UNITA_ORGANIZZATIVA,
       ORDINE_ACQ_CONSEGNA.NUMERO PG_DOC,
       ...
       ORDINE_ACQ_CONSEGNA.RIGA,
       ORDINE_ACQ_CONSEGNA.CONSEGNA,
       EVASIONE_ORDINE.DATA_CONSEGNA DT_REGISTRAZIONE
FROM EVASIONE_ORDINE_RIGA
LEFT JOIN EVASIONE_ORDINE ON EVASIONE_ORDINE.CD_CDS = EVASIONE_ORDINE_RIGA.CD_CDS_ORDINE
...
LEFT JOIN ORDINE_ACQ_CONSEGNA ON EVASIONE_ORDINE_RIGA.CD_CDS_ORDINE = ORDINE_ACQ_CONSEGNA.CD_CDS
    AND EVASIONE_ORDINE_RIGA.CD_UNITA_OPERATIVA = ORDINE_ACQ_CONSEGNA.CD_UNITA_OPERATIVA
    AND EVASIONE_ORDINE_RIGA.ESERCIZIO_ORDINE = ORDINE_ACQ_CONSEGNA.ESERCIZIO
    AND EVASIONE_ORDINE_RIGA.CD_NUMERATORE_ORDINE = ORDINE_ACQ_CONSEGNA.CD_NUMERATORE
    AND EVASIONE_ORDINE_RIGA.NUMERO_ORDINE = ORDINE_ACQ_CONSEGNA.NUMERO
    AND EVASIONE_ORDINE_RIGA.RIGA_ORDINE = ORDINE_ACQ_CONSEGNA.RIGA
    AND EVASIONE_ORDINE_RIGA.CONSEGNA = ORDINE_ACQ_CONSEGNA.CONSEGNA
WHERE EVASIONE_ORDINE_RIGA.STATO = 'INS'
