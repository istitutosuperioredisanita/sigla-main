...
public class Compenso_riga_ecoBase extends Compenso_riga_ecoKey implements Keyed {
    ...
    public Compenso_riga_ecoBase() {
        super();
    }

    public Compenso_riga_ecoBase(String cd_cds, String cd_unita_organizzativa, Integer esercizio, Long pg_compenso, Long progressivo_riga_eco) {
