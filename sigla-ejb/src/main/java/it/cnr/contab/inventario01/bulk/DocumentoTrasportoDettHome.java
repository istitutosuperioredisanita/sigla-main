 ...
 */
public class DocumentoTrasportoDettHome extends Doc_trasporto_rientro_dettHome {


	public DocumentoTrasportoDettHome(Connection conn) {
		super(DocumentoTrasportoDettBulk.class, conn);
	}

	public DocumentoTrasportoDettHome(Connection conn, PersistentCache persistentCache) {
