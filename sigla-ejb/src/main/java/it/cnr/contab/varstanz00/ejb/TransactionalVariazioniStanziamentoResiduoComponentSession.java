...
public class TransactionalVariazioniStanziamentoResiduoComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements VariazioniStanziamentoResiduoComponentSession {
	...
	public it.cnr.jada.bulk.OggettoBulk annullaApprovazione(it.cnr.jada.UserContext param0,it.cnr.jada.bulk.OggettoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
			return (it.cnr.jada.bulk.OggettoBulk)invoke("annullaApprovazione",new Object[] {
					param0,
					param1});
		} catch(java.rmi.RemoteException e) {
			throw e;
