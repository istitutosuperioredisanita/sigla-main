...
public class TransactionalDocumentoGenericoComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements DocumentoGenericoComponentSession {
	public it.cnr.jada.bulk.OggettoBulk aggiornaModalita(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk param1,it.cnr.contab.docamm00.docs.bulk.Documento_generico_rigaBulk param2,it.cnr.contab.anagraf00.core.bulk.TerzoBulk param3) throws RemoteException,it.cnr.jada.comp.ComponentException,it.cnr.jada.persistency.PersistencyException,it.cnr.jada.persistency.IntrospectionException {
		try {
			return (it.cnr.jada.bulk.OggettoBulk)invoke("aggiornaModalita",new Object[] {
				param0,
				param1,
				param2,
				param3 });
	...
	public it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk cercaCambio(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
			return (it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk)invoke("cercaCambio",new Object[] {
				param0,
				param1 });
		} catch(java.rmi.RemoteException e) {
			throw e;
	...
	public it.cnr.jada.bulk.OggettoBulk completaTerzo(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk param1,it.cnr.contab.docamm00.docs.bulk.Documento_generico_rigaBulk param2,it.cnr.contab.anagraf00.core.bulk.TerzoBulk param3) throws RemoteException,it.cnr.jada.comp.ComponentException,it.cnr.jada.persistency.PersistencyException,it.cnr.jada.persistency.IntrospectionException {
		try {
			return (it.cnr.jada.bulk.OggettoBulk)invoke("completaTerzo",new Object[] {
				param0,
				param1,
				param2,
				param3 });
	...
	public it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk contabilizzaDettagliSelezionati(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk param1,java.util.Collection param2,it.cnr.contab.doccont00.core.bulk.Accertamento_scadenzarioBulk param3) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
			return (it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk)invoke("contabilizzaDettagliSelezionati",new Object[] {
				param0,
				param1,
				param2,
				param3 });
	...
	public void controllaQuadraturaAccertamenti(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
	...
	public void controllaQuadraturaObbligazioni(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
	...
	public it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk eliminaLetteraPagamentoEstero(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
	...
	public void eliminaRiga(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_generico_rigaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
	...
	public it.cnr.contab.anagraf00.core.bulk.TerzoBulk findCessionario(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_generico_rigaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
	...
	public java.util.Collection findListabanche(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_generico_rigaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException,it.cnr.jada.persistency.PersistencyException,it.cnr.jada.persistency.IntrospectionException {
		try {
	...
	public java.util.Collection findTipi_doc_for_search(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException,it.cnr.jada.persistency.PersistencyException,it.cnr.jada.persistency.IntrospectionException {
		try {
			return (java.util.Collection)invoke("findTipi_doc_for_search",new Object[] {
				param0,
				param1 });
		} catch(java.rmi.RemoteException e) {
			throw e;
	...
	public it.cnr.contab.anagraf00.core.bulk.TerzoBulk getTerzoDefault(it.cnr.jada.UserContext param0) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
			return (it.cnr.contab.anagraf00.core.bulk.TerzoBulk)invoke("getTerzoDefault",new Object[] {
				param0 });
		} catch(java.rmi.RemoteException e) {
			throw e;
		} catch(java.lang.reflect.InvocationTargetException e) {
	...
	public void inserisciRiga(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_generico_rigaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
	...
	public it.cnr.contab.anagraf00.core.bulk.BancaBulk setContoEnteIn(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_generico_rigaBulk param1,java.util.List param2) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
			return (it.cnr.contab.anagraf00.core.bulk.BancaBulk)invoke("setContoEnteIn",new Object[] {
				param0,
				param1,
				param2 });
		} catch(java.rmi.RemoteException e) {
	...
	public it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk setEnte(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
			return (it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk)invoke("setEnte",new Object[] {
				param0,
				param1 });
		} catch(java.rmi.RemoteException e) {
			throw e;
	...
	public void validaDocumento(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
			invoke("validaDocumento",new Object[] {
				param0,
				param1 });
		} catch(java.rmi.RemoteException e) {
			throw e;
	...
	public void validaRiga(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_generico_rigaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
	...
	public it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk rebuildDocumento(it.cnr.jada.UserContext param0, it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
			return (it.cnr.contab.docamm00.docs.bulk.Documento_genericoBulk)invoke("rebuildDocumento",new Object[] {
				param0,
				param1 });
		} catch(java.rmi.RemoteException e) {
			throw e;
	...
	public it.cnr.jada.util.RemoteIterator selectBeniFor(it.cnr.jada.UserContext param0,Documento_genericoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
	...
	public void rimuoviDaAssociazioniInventario(UserContext param0, Documento_generico_rigaBulk param1, Ass_inv_bene_fatturaBulk param2) throws ComponentException, RemoteException {
		try {
	...
	public void rimuoviDaAssociazioniInventario(UserContext param0, Ass_inv_bene_fatturaBulk param1) throws ComponentException, RemoteException {
		try {
			invoke("rimuoviDaAssociazioniInventario",new Object[] {
				param0,
				param1 });
	...
	public java.util.List findMandatoRigaCollegati(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_generico_rigaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException,it.cnr.jada.persistency.PersistencyException,it.cnr.jada.persistency.IntrospectionException {
		try {
			return (java.util.List)invoke("findMandatoRigaCollegati",new Object[] {
				param0,
				param1 });
		} catch(java.rmi.RemoteException e) {
			throw e;
	...
	public java.util.List findReversaleRigaCollegate(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Documento_generico_rigaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException,it.cnr.jada.persistency.PersistencyException,it.cnr.jada.persistency.IntrospectionException {
		try {
			return (java.util.List)invoke("findReversaleRigaCollegate",new Object[] {
				param0,
				param1 });
		} catch(java.rmi.RemoteException e) {
			throw e;
	...
	public V_doc_passivo_obbligazioneBulk sdoppiaDettagliInAutomatico(UserContext userContext, V_doc_passivo_obbligazioneBulk docPassivo, BigDecimal newImporto) throws RemoteException,it.cnr.jada.comp.ComponentException {
		try {
