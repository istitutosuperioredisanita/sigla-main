...
//	}
    ...
    public Forward doSalva(ActionContext context) throws java.rmi.RemoteException {
       ...
       if (fatturaPassivaBulk.checkImportoDettagliIntrastat())
           return openConfirm(context, "Attenzione! L'importo di righe Istato superano il totale "+ fatturaPassivaBulk.getImportoTotInstrat().toString()+". Vuoi continuare?", OptionBP.CONFIRM_YES_NO, "doConfirmImportoInstrastat");
