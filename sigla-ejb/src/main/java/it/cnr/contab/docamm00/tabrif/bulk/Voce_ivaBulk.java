...
public class Voce_ivaBulk extends Voce_ivaBase {
    ...
    */
    ...
    protected final static java.lang.Boolean TRUE = Boolean.TRUE;
    protected final static java.lang.Boolean FALSE = Boolean.FALSE;
	...
	*/
    ...
    public Boolean isOperazioneNonImponibile() {
		return getPercentuale() != null && getPercentuale().compareTo(BigDecimal.ZERO) == 0;
	}
    ...
    public Boolean isCodiceIvaSoggettoBollo() {
		return SOGGETTO_BOLLO.equals(getTi_bollo());
	}
