...
public class Fattura_attiva_riga_ecoBase extends Fattura_attiva_riga_ecoKey implements Keyed {
    ...
    public Fattura_attiva_riga_ecoBase() {
        super();
    }

    public Fattura_attiva_riga_ecoBase(String cd_cds, String cd_unita_organizzativa, Integer esercizio, Long pg_fattura_attiva, Long progressivo_riga, Long progressivo_riga_eco) {
