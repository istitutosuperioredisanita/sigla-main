...
public class CRUDAssTipoRuoloPrivBP extends SimpleCRUDBP {
    ...
    private final SimpleDetailCRUDController crudAccessi_disponibili = new SimpleDetailCRUDController("Accessi_disponibili", AccessoBulk.class, "accessi_disponibili", this){
        public void setFilter(ActionContext actioncontext, CompoundFindClause compoundfindclause) {
            ...
            CRUDAssTipoRuoloPrivBP bp = (CRUDAssTipoRuoloPrivBP) actioncontext.getBusinessProcess();
    ...
    public CRUDAssTipoRuoloPrivBP() throws BusinessProcessException {
        super();

    }

    public CRUDAssTipoRuoloPrivBP(String function) throws BusinessProcessException {
        super(function);
    ...
    public void edit(ActionContext context, OggettoBulk bulk) throws BusinessProcessException {
