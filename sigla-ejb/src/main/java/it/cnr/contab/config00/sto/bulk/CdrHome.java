...
//		return getLunghezza_chiaviHome().create().formatCdrKey( codice, esercizio, livello );
    ...
    public CdrBulk findCdrEnte(Integer esercizio) throws PersistencyException, ApplicationException {
        ...
        sql.addSQLClause("AND", "UNITA_ORGANIZZATIVA.CD_TIPO_UNITA", SQLBuilder.EQUALS, Tipo_unita_organizzativaHome.TIPO_UO_ENTE);
        ...
        sql.addSQLClause("AND", "CDR.CD_UNITA_ORGANIZZATIVA", SQLBuilder.EQUALS, ((Unita_organizzativaBulk) uo.get(0)).getCd_unita_organizzativa());
        ...
        sql.addSQLClause("AND", "ESERCIZIO_FINE", SQLBuilder.GREATER_EQUALS, esercizio);
    ...
    public CdrBulk findCdrSAC(Integer esercizio) throws PersistencyException, ApplicationException {
        ...
        sql.addSQLClause("AND", "UNITA_ORGANIZZATIVA.FL_UO_CDS", SQLBuilder.EQUALS, "Y");
        sql.addSQLClause("AND", "UNITA_ORGANIZZATIVA.CD_TIPO_UNITA", SQLBuilder.EQUALS, Tipo_unita_organizzativaHome.TIPO_UO_SAC);
        sql.addSQLClause("AND", "UNITA_ORGANIZZATIVA.ESERCIZIO_INIZIO", SQLBuilder.LESS_EQUALS, esercizio);
        sql.addSQLClause("AND", "UNITA_ORGANIZZATIVA.ESERCIZIO_FINE", SQLBuilder.GREATER_EQUALS, esercizio);
        java.util.List uo = uo_home.fetchAll(sql);
        if (uo.isEmpty()) return null;
