...
public class Semaforo_staticoKey extends OggettoBulk implements KeyedPersistent {
	...
	public Semaforo_staticoKey() {
		super();
	}

    public Semaforo_staticoKey(Integer esercizio, String cd_tipo_semaforo, String cd_cds, String cd_unita_organizzativa, String cd_centro_responsabilita) {
    ...
    public boolean equalsByPrimaryKey(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof Semaforo_staticoKey))
			return false;
		Semaforo_staticoKey k = (Semaforo_staticoKey) o;
