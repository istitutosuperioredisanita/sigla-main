...
public class TransactionalPDCEconPatrComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements PDCEconPatrComponentSession {
