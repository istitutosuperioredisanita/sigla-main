...
public class LogRegistryComponentSessionBean extends it.cnr.jada.ejb.RicercaComponentSessionBean implements LogRegistryComponentSession {
	...
	public it.cnr.jada.util.RemoteIterator cercaTabelleDiLog(it.cnr.jada.UserContext param0,it.cnr.jada.persistency.sql.CompoundFindClause param1,it.cnr.jada.bulk.OggettoBulk param2) throws it.cnr.jada.comp.ComponentException,jakarta.ejb.EJBException {
