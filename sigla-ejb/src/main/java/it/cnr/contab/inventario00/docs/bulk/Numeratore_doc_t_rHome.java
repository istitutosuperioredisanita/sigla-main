...
public class Numeratore_doc_t_rHome extends BulkHome {
    ...
    public Long getNextPg(
        ...
        try {
            ...
            if (numeratore == null) {
                ...
                if(numeratore.getIniziale().equals(new Long("0"))) numeratore.setIniziale(new Long("1"));
    ...
    public Long getNextTempPg(
        ...
        try {
            ...
            if (tipoDocumento.equalsIgnoreCase("T")) {
                tipoDocTemp = "A";
            } else if (tipoDocumento.equalsIgnoreCase("R")) {
                tipoDocTemp = "B";
            }
            ...
            Numeratore_doc_t_rBulk progressivo_def = (Numeratore_doc_t_rBulk) findByPrimaryKey(
                    new Numeratore_doc_t_rKey(progressivoInventario, tipoDocumento, esercizio));
