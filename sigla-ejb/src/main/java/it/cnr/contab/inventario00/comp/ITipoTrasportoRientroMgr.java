...
public interface ITipoTrasportoRientroMgr extends ICRUDMgr
{

/** 
  * Eliminazione di un tipo di Movimento
  *    PreCondition:
  *      E' stata generata la richiesta di eliminazione di un tipo di Movimento Trasporto/Rientro dell'Inventario.
  *    PostCondition:
...
public abstract void eliminaConBulk(UserContext param0, OggettoBulk param1) throws ComponentException;
}