...
java.util.List findBancaOptions(it.cnr.jada.UserContext param0,Integer param1, String param2) throws it.cnr.jada.persistency.PersistencyException,it.cnr.jada.persistency.IntrospectionException,it.cnr.jada.comp.ComponentException,java.rmi.RemoteException;
