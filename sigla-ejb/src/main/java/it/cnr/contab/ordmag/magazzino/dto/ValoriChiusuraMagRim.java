...
public class ValoriChiusuraMagRim implements Serializable{
    ...
    public BigDecimal getCaricoIniziale() {
        return caricoIniziale;
    }

    public void setCaricoIniziale(BigDecimal caricoIniziale) {
        this.caricoIniziale = caricoIniziale;
    }

    public BigDecimal getCaricoAnno() {
        return caricoAnno;
    }

    public void setCaricoAnno(BigDecimal caricoAnno) {
        this.caricoAnno = caricoAnno;
    }

    public BigDecimal getScaricoAnno() {
        return scaricoAnno;
    }

    public void setScaricoAnno(BigDecimal scaricoAnno) {
