 ...
 */
public class StampaBollaScaricoMagHome extends BulkHome {
	/**
	 * Stampa_consumiHome constructor comment.
	 * @param clazz java.lang.Class
	 * @param conn java.sql.Connection
	 */
	private transient static final Logger _log = LoggerFactory.getLogger(StampaBollaScaricoMagHome.class);
	public StampaBollaScaricoMagHome(Class clazz, java.sql.Connection conn) {
		super(clazz, conn);
	}
	/**
	 * Stampa_consumiHome constructor comment.
	 ...
	 */
	public StampaBollaScaricoMagHome(Class clazz, java.sql.Connection conn, it.cnr.jada.persistency.PersistentCache persistentCache) {
	 ...
	 * @param conn java.sql.Connection
	 */
	public StampaBollaScaricoMagHome(java.sql.Connection conn) {
	 ...
	 * @param persistentCache it.cnr.jada.persistency.PersistentCache
	 */
	public StampaBollaScaricoMagHome(java.sql.Connection conn, it.cnr.jada.persistency.PersistentCache persistentCache) {
