...
public class OrdineAcqEcoKey extends OggettoBulk implements KeyedPersistent {
    ...
    public OrdineAcqEcoKey() {
        super();
    }

    public OrdineAcqEcoKey(String cdCds, String cdUnitaOperativa, Integer esercizio, String cdNumeratore, Integer numero, Long progressivo_riga_eco) {
        super();
        this.cdCds=cdCds;
    ...
    public boolean equalsByPrimaryKey(Object o) {
        ...
        if (!(o instanceof OrdineAcqEcoKey)) return false;
        OrdineAcqEcoKey k = (OrdineAcqEcoKey) o;
