...
public class ConsPDGPAreaBP extends ConsultazioniBP {
	...
	public ConsPDGPAreaComponentSession createPdgpAreaComponentSession() throws jakarta.ejb.EJBException,java.rmi.RemoteException {
	   ...
	   protected void init(it.cnr.jada.action.Config config,it.cnr.jada.action.ActionContext context) throws it.cnr.jada.action.BusinessProcessException {
		   ...
		   if (getPathConsultazione()==null) {
				if (this instanceof ConsPDGPAreaEtrBP){
	   ...
	   public void setTitle() {
		   String title=null;
		   if (this instanceof ConsPDGPAreaEtrBP)
			   title = "Riepilogo PDGP per Area/Istituto-Entrate";
		   else
			   title = "Riepilogo PDGP per Area/Istituto-Spese";
	   ...
	   public String getDs_livello1(UserContext userContext) throws BusinessProcessException {
		   try {
			   if (getDs_livello1()==null) {
				   if (this instanceof ConsPDGPAreaSpeBP)
	...
	/**
	   ...
	   public CompoundFindClause getSelezione(ActionContext context) throws it.cnr.jada.action.BusinessProcessException {
		   try	{
			   ...
			   {
				   V_cons_pdgp_areaBulk wpb = (V_cons_pdgp_areaBulk)i.next();
