 ...
 */
public class ConsPDGPDipComponent extends CRUDComponent {
		...
		private RemoteIterator findConsultazioneDettaglio(UserContext userContext, String pathDestinazione, String livelloDestinazione, CompoundFindClause baseClause, CompoundFindClause findClause, String tipoCons) throws it.cnr.jada.comp.ComponentException {
			try{
				...
				BulkHome home = getHome(userContext, V_cons_pdgp_dipBulk.class, pathDestinazione);
				...
				return iterator(userContext,completaSQL(sql,sqlEsterna,tabAlias,baseClause,findClause),V_cons_pdgp_dipBulk.class,null);
	...
	private void addBaseColumns(UserContext userContext,SQLBuilder sql, SQLBuilder sqlEsterna, String tabAlias, String pathDestinazione, String livelloDestinazione) throws it.cnr.jada.comp.ComponentException {
		...
		sqlEsterna.resetColumns();
			...
			if (pathDestinazione.indexOf(ConsPDGPDipBP.LIVELLO_CDR)>=0) {
				addColumnCDR(sql,tabAlias,(livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_ETRCDR)||livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_SPECDR)),true,pathDestinazione);
				addColumnCDR(sqlEsterna,tabAlias,(livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_ETRCDR)||livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_SPECDR)),false,pathDestinazione);
			}
			if (pathDestinazione.indexOf(ConsPDGPDipBP.LIVELLO_DIP)>=0){
				addColumnDIP(sql,tabAlias,livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_DIP),true);
				addColumnDIP(sqlEsterna,tabAlias,livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_DIP),false);
			}
			if (pathDestinazione.indexOf(ConsPDGPDipBP.LIVELLO_PRO)>=0){
				addColumnPRO(sql,tabAlias,livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_PRO),true);
				addColumnPRO(sqlEsterna,tabAlias,livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_PRO),false);
			}
			if (pathDestinazione.indexOf(ConsPDGPDipBP.LIVELLO_COM)>=0){
				addColumnCOM(sql,tabAlias,livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_COM),true);
				addColumnCOM(sqlEsterna,tabAlias,livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_COM),false);
			}
			if (pathDestinazione.indexOf(ConsPDGPDipBP.LIVELLO_MOD)>=0){
				addColumnMOD(sql,tabAlias,livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_MOD),true);
				addColumnMOD(sqlEsterna,tabAlias,livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_MOD),false);
			}
			if (pathDestinazione.indexOf(ConsPDGPDipBP.LIVELLO_LIV1)>=0){
				addColumnLIV1(sql,tabAlias,livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_LIV1),true,livelloDestinazione,userContext);
				addColumnLIV1(sqlEsterna,tabAlias,livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_LIV1),false,livelloDestinazione,userContext);
			}
			if (pathDestinazione.indexOf(ConsPDGPDipBP.LIVELLO_LIV2)>=0){
				addColumnLIV2(sql,tabAlias,livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_LIV2),true);
				addColumnLIV2(sqlEsterna,tabAlias,livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_LIV2),false);
			}
			if (pathDestinazione.indexOf(ConsPDGPDipBP.LIVELLO_LIV3)>=0){
				addColumnLIV3(sql,tabAlias,livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_LIV3),true);
				addColumnLIV3(sqlEsterna,tabAlias,livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_LIV3),false);
			}
			if (pathDestinazione.indexOf(ConsPDGPDipBP.LIVELLO_DET)>=0){
				addColumnDET(sql,tabAlias,livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_DET),true);
				addColumnDET(sqlEsterna,tabAlias,livelloDestinazione.equals(ConsPDGPDipBP.LIVELLO_DET),false);
			}	
		...
		private void addColumnLIV1(SQLBuilder sql, String tabAlias, boolean addDescrizione, boolean isBaseSQL,String livello_arrivo,UserContext context) throws ComponentException{ 
			...
			if (tabAlias.indexOf("V_CONS_PDG_SPE_BIL_IST_DIP_FO")>=0 && livello_arrivo.compareTo(ConsPDGPDipBP.LIVELLO_LIV1)==0){
				if (isBaseSQL){
