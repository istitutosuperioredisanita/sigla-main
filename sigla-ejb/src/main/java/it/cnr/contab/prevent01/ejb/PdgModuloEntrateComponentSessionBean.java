...
public class PdgModuloEntrateComponentSessionBean extends it.cnr.jada.ejb.CRUDComponentSessionBean implements PdgModuloEntrateComponentSession {
	...
	public java.util.Collection findNatura(it.cnr.jada.UserContext param0,it.cnr.contab.prevent01.bulk.Pdg_Modulo_EntrateBulk param1) throws it.cnr.jada.comp.ComponentException,it.cnr.jada.persistency.PersistencyException,jakarta.ejb.EJBException {
		pre_component_invocation(param0,componentObj);
		try {
	...
	public boolean isUtenteEnte(it.cnr.jada.UserContext param0) throws it.cnr.jada.comp.ComponentException,jakarta.ejb.EJBException {
		pre_component_invocation(param0,componentObj);
		try {
	...
	public it.cnr.contab.prevent01.bulk.Pdg_Modulo_EntrateBulk getPdgModuloEntrateBulk(it.cnr.jada.UserContext param0, it.cnr.contab.pdg01.consultazioni.bulk.V_cons_pdgp_pdgg_etrBulk param1) throws it.cnr.jada.comp.ComponentException,jakarta.ejb.EJBException {
		pre_component_invocation(param0,componentObj);
		try {
