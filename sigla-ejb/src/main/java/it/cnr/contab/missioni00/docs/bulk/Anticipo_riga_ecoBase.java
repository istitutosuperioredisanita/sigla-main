...
public class Anticipo_riga_ecoBase extends Anticipo_riga_ecoKey implements Keyed {
    ...
    public Anticipo_riga_ecoBase() {
        super();
    }

    public Anticipo_riga_ecoBase(String cd_cds, String cd_unita_organizzativa, Integer esercizio, Long pg_anticipo, Long progressivo_riga_eco) {
