...
public class MissioneBase extends MissioneKey implements Keyed {
    ...
    /*
     * Getter dell'attributo im_spese_tracc
     */
    public BigDecimal getIm_spese_tracc() {
        return im_spese_tracc;
    }

    /*
     * Getter dell'attributo im_spese_no_tracc
     */
    public BigDecimal getIm_spese_no_tracc() {
        return im_spese_no_tracc;
    }
    ...
    /*
     * Setter dell'attributo im_spese_tracc
     */
    public void setIm_spese_tracc(BigDecimal im_spese_tracc) {
        this.im_spese_tracc = im_spese_tracc;
    }

    /*
     * Setter dell'attributo im_spese_no_tracc
     */
    public void setIm_spese_no_tracc(BigDecimal im_spese_no_tracc) {
        this.im_spese_no_tracc = im_spese_no_tracc;
    }
