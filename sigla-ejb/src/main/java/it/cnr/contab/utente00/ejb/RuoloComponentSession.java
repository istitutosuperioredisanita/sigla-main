...
public interface RuoloComponentSession extends it.cnr.jada.ejb.CRUDComponentSession {
    ...
    boolean isAbilitatoStampeRendProgetto(it.cnr.jada.UserContext param0) throws it.cnr.jada.comp.ComponentException, java.rmi.RemoteException;
     ...
     */
    boolean controlloAbilitazione(it.cnr.jada.UserContext userContext, String tipoAbilitazione) throws it.cnr.jada.comp.ComponentException, java.rmi.RemoteException;
}
